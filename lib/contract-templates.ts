...
export const billOfSaleTerms = [
  ...
  "The buyer acknowledges receiving the puppy information available in the private Buyer Puppy Portal, including known health, care, and identification records connected to this puppy at the time of transfer.",
...
export const virginiaConsumerNotice = `IMPORTANT CONSUMER-LAW NOTICE

The sale or placement of a dog may be regulated by the laws where the Seller, Buyer, or puppy is located. Those laws may require specific disclosures, veterinary-certification procedures, deadlines, refund or replacement choices, registration-paper duties, or other remedies.

Before using this agreement, the Seller must replace or supplement this notice with every disclosure required in the applicable jurisdiction. The Buyer should retain the signed agreement, health records, and all veterinary records and act within any legally required deadline.

Nothing in this agreement waives, shortens, or restricts a consumer right or remedy that cannot legally be waived.`;
...
export function healthGuaranteeTerms(examHours: number, guaranteeMonths: number, microToy = false) {
  ...
  const terms = [
    ...
    "The Seller certifies that, at the time of transfer, the puppy identified in this agreement is believed to be free from known contagious or infectious disease and known serious congenital defects, except for any condition expressly disclosed to the Buyer in writing.",
    ...
    microToy
      ? "This puppy is expressly designated as a Micro-Toy Puppy. The voluntary congenital and hereditary defect guarantee in this section does not apply, subject always to the Buyer's nonwaivable rights under applicable law."
    ...
    "Giardia, coccidia, kennel cough, parvovirus, and other infections or parasites contracted after transfer are not covered by the voluntary guarantee. This exclusion does not restrict any statutory remedy available under applicable law.",
    "A condition is not automatically excluded solely because it is common in the puppy's breed or size category. An exclusion applies only as stated in this agreement and as permitted by applicable law.",
  ...
  terms.push(
    ...
    "The Buyer will follow all individualized breed-, age-, and size-appropriate feeding instructions, monitor food and water intake, and promptly respond to decreased appetite or signs of illness, particularly during the first weeks at home and during travel, stress, vaccination, or environmental change.",
    microToy
    ...
    "This Health Guarantee is the complete agreement concerning the Seller's health commitments and supersedes prior statements on that subject. A modification must be in writing and signed by both parties. If a provision is invalid or unenforceable, it will be enforced to the greatest lawful extent and the remaining provisions will continue. Governing law and venue are determined by the completed agreement and applicable law.",

    contractSection("Applicable consumer-law notice"),
    contractNotice(virginiaConsumerNotice),

    contractSection("Buyer acknowledgment and electronic records"),
    "By signing, the Buyer confirms that the Buyer reviewed this complete Health Guarantee; the available health and preventive-care records; feeding, safety, and emergency-care instructions; voluntary guarantee limitations and exclusions; any special designation when applicable; and the consumer-law notice, and had an opportunity to ask questions before signing.",
