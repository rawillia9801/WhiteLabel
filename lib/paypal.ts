...
export const recurringOfferings: readonly RecurringOffering[] = [
  ...
  { key: "professional-monthly", group: "platform", productName: "MyDogPortal Professional", planName: "Professional Monthly — 2026 Pricing", name: "Professional", description: "MyDogPortal Professional with a 14-day free trial, then $69/month.", price: "69.00", intervalUnit: "MONTH", intervalLabel: "month", trial: { intervalUnit: "DAY", intervalCount: 14 }, entitlementPlan: "professional" },
  { key: "professional-annual", group: "platform", productName: "MyDogPortal Professional", planName: "Professional Annual — 2026 Pricing", name: "Professional", description: "MyDogPortal Professional with a 14-day free trial, then $690/year.", price: "690.00", intervalUnit: "YEAR", intervalLabel: "year", trial: { intervalUnit: "DAY", intervalCount: 14 }, entitlementPlan: "professional" },
  { key: "studio-monthly", group: "platform", productName: "MyDogPortal Studio", planName: "Studio Monthly — 2026 Pricing", name: "Studio", description: "MyDogPortal Studio with a 14-day free trial, then $119/month.", price: "119.00", intervalUnit: "MONTH", intervalLabel: "month", trial: { intervalUnit: "DAY", intervalCount: 14 }, entitlementPlan: "custom_domain" },
  { key: "studio-annual", group: "platform", productName: "MyDogPortal Studio", planName: "Studio Annual — 2026 Pricing", name: "Studio", description: "MyDogPortal Studio with a 14-day free trial, then $1,190/year.", price: "1190.00", intervalUnit: "YEAR", intervalLabel: "year", trial: { intervalUnit: "DAY", intervalCount: 14 }, entitlementPlan: "custom_domain" },
  { key: "founding-starter-monthly", group: "platform", productName: "MyDogPortal Starter", planName: "Founding Starter Monthly", name: "Starter", description: "Founding Breeder Starter with a 14-day free trial, then $19/month while the subscription remains continuously active.", price: "19.00", intervalUnit: "MONTH", intervalLabel: "month", trial: { intervalUnit: "DAY", intervalCount: 14 }, entitlementPlan: "starter" },
  { key: "founding-starter-annual", group: "platform", productName: "MyDogPortal Starter", planName: "Founding Starter Annual", name: "Starter", description: "Founding Breeder Starter with a 14-day free trial, then $190/year while the subscription remains continuously active.", price: "190.00", intervalUnit: "YEAR", intervalLabel: "year", trial: { intervalUnit: "DAY", intervalCount: 14 }, entitlementPlan: "starter" },
  { key: "founding-professional-monthly", group: "platform", productName: "MyDogPortal Professional", planName: "Founding Professional Monthly", name: "Professional", description: "Founding Breeder Professional with a 14-day free trial, then $39/month while the subscription remains continuously active.", price: "39.00", intervalUnit: "MONTH", intervalLabel: "month", trial: { intervalUnit: "DAY", intervalCount: 14 }, entitlementPlan: "professional" },
  { key: "founding-professional-annual", group: "platform", productName: "MyDogPortal Professional", planName: "Founding Professional Annual", name: "Professional", description: "Founding Breeder Professional with a 14-day free trial, then $390/year while the subscription remains continuously active.", price: "390.00", intervalUnit: "YEAR", intervalLabel: "year", trial: { intervalUnit: "DAY", intervalCount: 14 }, entitlementPlan: "professional" },
  { key: "founding-studio-monthly", group: "platform", productName: "MyDogPortal Studio", planName: "Founding Studio Monthly", name: "Studio", description: "Founding Breeder Studio with a 14-day free trial, then $69/month while the subscription remains continuously active.", price: "69.00", intervalUnit: "MONTH", intervalLabel: "month", trial: { intervalUnit: "DAY", intervalCount: 14 }, entitlementPlan: "custom_domain" },
  { key: "founding-studio-annual", group: "platform", productName: "MyDogPortal Studio", planName: "Founding Studio Annual", name: "Studio", description: "Founding Breeder Studio with a 14-day free trial, then $690/year while the subscription remains continuously active.", price: "690.00", intervalUnit: "YEAR", intervalLabel: "year", trial: { intervalUnit: "DAY", intervalCount: 14 }, entitlementPlan: "custom_domain" },
  { key: "hosting-monthly", group: "service", productName: "Dog Breeder Web Website Service", planName: "Dog Breeder Web Monthly — 2026 Pricing", name: "Dog Breeder Web", description: "Complete dog-breeder website service with BreederWeb Designer, managed hosting, SSL, two branded business email addresses, publishing, forms, embeds, brand controls, and integration readiness.", price: "24.95", intervalUnit: "MONTH", intervalLabel: "month", entitlementPlan: null },
  { key: "brand-launch-renewal", group: "service", productName: "Dog Breeder Brand Launch", planName: "Brand Launch + Domain Renewal — 2026 Pricing", name: "Brand Launch", description: "$149 setup and first-year standard .com registration, then $39/year managed renewal after the first year.", price: "39.00", intervalUnit: "YEAR", intervalLabel: "year", trial: { intervalUnit: "YEAR", intervalCount: 1 }, setupFee: "149.00", entitlementPlan: null },
