...
const faqs = [
  ...
  ["What exactly does Studio include?", "Studio includes everything in Professional plus Brand Launch, personalization of a supported breeder website, website hosting, two branded business email addresses, an available standard .com with annual renewal while Studio remains active, a local Business Voice number with custom IVR, and up to $20 per month in voice usage. Premium domains and ground-up custom websites are separately scoped."],
