...
const plans = [
  ...
  ["Studio", "$99", "$990", "RUN YOUR BUSINESS + YOUR BRAND", "Over $1,100.00 Added Value · Prices Locked In", ["Everything in Professional", "Brand Launch setup — $149 value", "Breeder Website Personalization — $299 value", "Standard .com registration + renewal — $29 value", "Website hosting + two business emails — $215.40/year value", "Business Voice number + custom IVR — $176.88 value", "Phone System Credits — $240/year value", "Connected public puppy data"]],
] as const;

const services = [
  [Globe2, "Website Hosting + Business Email", "$17.95/month", "Standalone website hosting and professional email exclusively for dog breeders. No MyDogPortal software subscription is required or included.", ["Managed website hosting", "Two branded business email addresses", "SSL for the hosted website", "Basic hosting and email technical support", "Use your existing domain", "No MyDogPortal software or breeder-management features included"]],
  [Globe2, "Brand Launch", "$149 one-time", "Register and configure an available standard .com under your breeder brand.", ["Available standard .com registration", "Domain and DNS configuration", "SSL connection", "Managed standard .com renewal: $29/year", "Premium domains priced separately"]],
  [MonitorSmartphone, "Breeder Website Personalization", "$299 one-time", "Turn a supported MyDogPortal website style into your kennel's own polished public presence.", ["Your kennel identity, colors, photography, and content", "Supported page and layout personalization", "Connected MyDogPortal information"]],
  ...
  [PhoneCall, "Business Voice", "$69 setup", "A professionally configured local business voice line with your greeting and breeder information.", ["Local number: $8.99/month or $99/year", "Incoming calls: $0.03/minute", "Outgoing calls: $0.04/minute", "Custom IVR/menu, business hours, voicemail, and routing", "Live examples: Willow Creek (276) 250-9512 · Cedar & Creek (276) 276-2757"]],
] as const;
...
const faqs = [
  ...
  ["What exactly does Studio include?", "Studio includes everything in Professional plus Brand Launch ($149 value), supported breeder website personalization ($299 value), standard .com registration and renewal ($29 value), hosting plus two branded business emails ($215.40/year value), Business Voice number and custom IVR ($176.88 value), and $240/year in Phone System Credits. That is $1,109.28 in added service value before counting the value of the MyDogPortal software itself. Your Studio subscription rate is locked in while your Studio subscription remains continuously active. Premium domains, metered usage above included credits, and ground-up custom websites are separately scoped."],
  ...
  ["Can I start before deciding on a website or phone system?", "Yes. Starter and Professional can add hosting, Brand Launch, website personalization, or Business Voice later. Studio includes those launch services from the start."],
...
export default function MarketingPage() {
  return <main className="marketing-page">
    <nav className="marketing-nav" aria-label="Main navigation">
      ...
      <div><a href="#platform">Platform</a><a href="#workflow">Workflow</a><a href="#automation">Automation</a><a href="#customization">Customization</a><a href="#pricing">Pricing</a><a href="#examples">Templates</a><Link href="/login">Sign in</Link><Link className="marketing-nav-cta" href="/signup">Start free trial</Link></div>
    </nav>
    <section className="marketing-hero">
      <div className="marketing-hero-copy">
        ...
        <p>Run breeding, families, health, finances, documents, communications, and Puppy Portals from one customizable operating system. Automations carry information forward while your kennel name, colors, website, portal, and family experience stay unmistakably yours.</p>
        ...
        <div className="marketing-hero-proof"><span><Check size={13}/>14-day platform trial</span><span><Check size={13}/>Automated breeder workflows</span><span><Check size={13}/>Customizable website + Puppy Portal</span><span><Check size={13}/>Cancel anytime from your account</span></div>
      </div>
      <div className="marketing-portal-preview" aria-label="Preview of the real MyDogPortal Puppy Portal">
        <header><span><PawPrint size={17}/></span><div><b>Willow Creek Puppy Portal</b><small>PRIVATE FAMILY EXPERIENCE</small></div><i>SECURE</i></header>
        <div className="marketing-portal-frame">
          <aside className="marketing-portal-nav"><small>EMMA&apos;S PORTAL</small><b>Emma Harris</b><span className="active">Overview</span><span>My Puppy</span><span>Health &amp; Growth</span><span>Updates</span><span>Documents</span><span>Payments</span><span>Schedule</span><span>Messages</span></aside>
          <section className="marketing-portal-main"><small>PRIVATE FAMILY PORTAL</small><h2>Welcome, Emma</h2><p>Everything connected to your puppy journey, organized around what comes next.</p>
            <div className="marketing-portal-metrics"><span><small>ASSIGNED PUPPIES</small><b>1</b></span><span><small>PUBLISHED UPDATES</small><b>6</b></span><span><small>AWAITING SIGNATURE</small><b>1</b></span><span><small>OUTSTANDING BALANCE</small><b>$1,200</b></span></div>
            <div className="marketing-portal-journey"><div><small>YOUR JOURNEY</small><b>Placement milestones</b><p><span>✓</span> Family account active</p><p><span>✓</span> Puppy assigned</p><p><span>✓</span> Deposit recorded</p><p><span>○</span> Go-home scheduled</p></div><aside><b>80%</b><small>4 of 5 milestones complete</small></aside></div>
          </section>
        </div>
      </div>
    </section>
    ...
    <section className="marketing-connected" id="customization">
      <div className="marketing-connected-copy"><span className="marketing-kicker">CUSTOMIZATION THAT LOOKS LIKE YOUR KENNEL</span><h2>Your software should carry your brand—not replace it.</h2><p>Choose from five genuinely different breeder website starting points, then personalize the breed, kennel identity, colors, photography, dogs, litters, policies, application, and public content. Your private Puppy Portal carries the same breeder-branded family experience.</p><ul><li><Check size={15}/>Available puppies and planned litters</li><li><Check size={15}/>Dams, sires, health testing, policies, and applications</li><li><Check size={15}/>Your domain, photography, colors, and kennel identity</li><li><Check size={15}/>A clear path from your website into the private Puppy Portal</li></ul><a href="#examples">Compare live website templates <ArrowRight size={15}/></a></div>
    ...
    <section className="marketing-section marketing-pricing" id="pricing"><header><span className="marketing-kicker">SIMPLE PRICING · MONTHLY OR ANNUAL</span><h2>Choose how you want to run your program.</h2><p>Every plan starts with a 14-day platform trial. Annual pricing gives you two months free. Studio includes the complete breeder brand launch: website personalization, hosting, two business emails, standard .com registration and renewal, plus Business Voice with $20/month in included voice usage.</p></header><div className="marketing-plans">{plans.map(([name,price,annual,position,note,items])=><article className={name === "Professional" ? "featured" : ""} key={name}>{name === "Professional" && <em>MOST POPULAR</em>}<small className="marketing-plan-position">{position}</small><h3>{name}</h3><p><b>{price}</b><span>/month</span></p><div className="marketing-plan-annual"><b>{annual}/year</b><span>Two months free</span></div><small>{note}</small><ul>{items.map(item=><li key={item}><Check size={14}/>{item}</li>)}</ul><Link href={"/signup?plan=" + name.toLowerCase()}>Start free trial <ArrowRight size={15}/></Link></article>)}</div><p className="marketing-pricing-note"><b>Easy cancellation, without the runaround.</b> Monthly and annual subscriptions use connected PayPal checkout. Your 14-day $0 platform trial is built into the billing plan, and you can cancel your MyDogPortal subscription from your own account without opening a support ticket.</p></section>
    <section className="marketing-section marketing-services" id="services"><header><span className="marketing-kicker">OPTIONAL SERVICES FOR DOG BREEDERS</span><h2>Choose only the services you need.</h2><p>These are separate à-la-carte services for dog breeders. Each card below shows the standalone service and its actual price.</p></header><div className="marketing-service-grid">{services.map(([Icon,name,price,text,items])=><article key={name}><header><span><Icon size={21}/></span><div><h3>{name}</h3><strong>{price}</strong></div></header><p>{text}</p><ul>{items.map(item=><li key={item}><Check size={13}/>{item}</li>)}</ul><Link href="/signup">Choose this service <ArrowRight size={15}/></Link></article>)}</div><aside><ShieldCheck size={18}/><p><b>Studio package: Over $1,100.00 Added Value · Prices Locked In.</b> Studio combines $869.28 in brand, website, domain, hosting/email, and phone-system value plus $240/year in Phone System Credits—a $1,109.28 added service value before counting the MyDogPortal software itself. Usage above the included amount, premium domains, and ground-up custom websites are billed separately.</p></aside></section>
    <section className="marketing-section marketing-examples" id="examples">
      <header><span className="marketing-kicker">FIVE CUSTOMIZABLE BREEDER WEBSITE STARTING POINTS</span><h2>Choose a style that feels like your program.</h2><p>These are intentionally different—not five color swaps. Your breed, dogs, photography, colors, policies, applications, public puppy information, and Puppy Portal replace the demonstration content.</p></header>
      <div className="marketing-example-grid">
        <article><span><MonitorSmartphone size={23}/></span><small>WEBSITE TEMPLATE 01 · CHIHUAHUA</small><h3>Willow Creek Chihuahuas</h3><p>Bright, polished, boutique presentation for a companion-breed program. Business Voice: <b>(276) 250-9512</b>.</p><div className="marketing-example-actions"><a href="https://willowcreekchihuahuas.com" target="_blank" rel="noreferrer">Visit website <ExternalLink size={15}/></a><Link href="/signup?website_template=willow-creek">Choose style <ArrowRight size={15}/></Link></div></article>
        <article><span><Dog size={23}/></span><small>WEBSITE TEMPLATE 02 · GOLDEN RETRIEVER</small><h3>Cedar &amp; Creek Goldens</h3><p>Warm, editorial and outdoors-inspired, with family connection, health testing, and story-first presentation.</p><div className="marketing-example-actions"><Link href="/templates/cedar-creek">View template <ArrowRight size={15}/></Link><Link href="/signup?website_template=cedar-creek">Choose style <ArrowRight size={15}/></Link></div></article>
        <article><span><MonitorSmartphone size={23}/></span><small>WEBSITE TEMPLATE 03 · STANDARD POODLE</small><h3>Northstar Standard Poodles</h3><p>Luxury minimal editorial design centered on refinement, pedigree context, health transparency, and an elevated brand feel.</p><div className="marketing-example-actions"><Link href="/templates/northstar-poodles">View template <ArrowRight size={15}/></Link><Link href="/signup?website_template=northstar-poodles">Choose style <ArrowRight size={15}/></Link></div></article>
        <article><span><Dog size={23}/></span><small>WEBSITE TEMPLATE 04 · AUSTRALIAN SHEPHERD</small><h3>Bluebird Aussies</h3><p>Bright, colorful modern-ranch styling for active programs that want warmth, personality, puppy development, and family storytelling.</p><div className="marketing-example-actions"><Link href="/templates/bluebird-aussies">View template <ArrowRight size={15}/></Link><Link href="/signup?website_template=bluebird-aussies">Choose style <ArrowRight size={15}/></Link></div></article>
        <article><span><ShieldCheck size={23}/></span><small>WEBSITE TEMPLATE 05 · GERMAN SHEPHERD</small><h3>Ironwood German Shepherds</h3><p>Bold structured performance design for working and sport programs emphasizing health, temperament, training, pedigree, and purpose.</p><div className="marketing-example-actions"><Link href="/templates/ironwood-shepherds">View template <ArrowRight size={15}/></Link><Link href="/signup?website_template=ironwood-shepherds">Choose style <ArrowRight size={15}/></Link></div></article>
      </div>
    </section>
