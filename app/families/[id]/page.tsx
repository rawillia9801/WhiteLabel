...
export default function FamilyProfilePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => { if (family) document.title = `${fullName(family)} | Breeder Portal`; }, [family]);
