...
function CombinedAgreementFacts({ snapshot }: { snapshot: Snapshot }) {
  ...
  return <>
    ...
    <FactSection title="Puppy description and animal history" facts={[["Puppy", snapshot.puppyName], ["Breed", snapshot.puppyBreed || "Dog"], ["Sex", snapshot.puppySex], ["Date of birth", snapshot.puppyBirthDate ? date(snapshot.puppyBirthDate) : ""], ["Age at transfer", details.puppyAgeAtTransfer], ["Color / markings", snapshot.puppyColor], ["Coat type", details.puppyCoatType], ["Current weight", details.puppyCurrentWeight], ["Estimated adult size", details.estimatedAdultSize], ["Microchip", details.microchipNumber], ["Registry", details.registry], ["Registration number / status", details.registrationNumber], ["Very small / Micro-Toy designation", yesNo(snapshot.microToy)]]} />
