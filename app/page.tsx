...
export default function Home() {
  ...
  return <div className="bos-shell">
    ...
    <main className="bos-main">
      <a className="bos-profile-pill" href="/account" aria-label="Open breeder profile, subscription, and billing"><UserRound size={17}/><span><b>Breeder profile</b><small>Plan · billing · receipts</small></span><ChevronRight size={14}/></a>
