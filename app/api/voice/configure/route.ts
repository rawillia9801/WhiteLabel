...
export async function POST(request: Request) {
  ...
  const managedLines = [
    ...
    { id: "golden-retriever", phone: normalizePhone(process.env.SWVAOS_GOLDEN_NUMBER || DEFAULT_GOLDEN_NUMBER), friendlyName: process.env.GOLDEN_VOICE_BUSINESS_NAME?.trim() || "Cedar & Creek Goldens" },
