...
export async function GET(request: Request) {
  ...
  try {
    const rawData = await getKennelDataFromSupabase(session.kennelId);
...
export async function PUT(request: Request) {
  ...
  try {
    ...
    const updated = await updateSupabaseResource(body.resource, id, body.data, session.kennelId);
    try {
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    await deleteSupabaseResource(resource, id, session.kennelId);
